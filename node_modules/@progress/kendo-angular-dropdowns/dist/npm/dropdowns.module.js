...
var DropDownsModule = /** @class */ (function () {
    ...
    DropDownsModule = tslib_1.__decorate([
        core_1.NgModule({
            exports: [autocomplete_module_1.AutoCompleteModule, combobox_module_1.ComboBoxModule, dropdownlist_module_1.DropDownListModule, multiselect_module_1.MultiSelectModule, dropdowntrees_module_1.DropDownTreesModule]
        })
    ], DropDownsModule);
