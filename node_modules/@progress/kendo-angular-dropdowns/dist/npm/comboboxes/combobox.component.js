...
var ComboBoxComponent = /** @class */ (function () {
    ...
    ComboBoxComponent.prototype.createValueStream = function () {
        ...
        var valueStream = this.valueSubject.pipe(operators_1.filter(function (candidate) {
            var current = util_1.getter(_this.value, _this.valueField);
        ...
        var allowCustomValueStream = customValueStreams[0].pipe(operators_1.tap(function () {
            ...
            var hasChange = _this.text !== util_1.getter(_this.value, _this.valueField);
        ...
        this.valueSubscription = merged.pipe(operators_1.catchError(function () {
            var selectionChanged = util_1.getter(_this.dataItem, _this.valueField) !== undefined;
            ...
            var selectionChanged = util_1.getter(_this.dataItem, _this.valueField) !== util_1.getter(state.dataItem, _this.valueField);
    ...
    ComboBoxComponent.prototype.attachStreams = function () {
        ...
        this.subs.add(this.selectionService.onSelect.pipe(operators_1.filter(function (_) { return _this.isOpen; }), operators_1.tap(function (_) { return _this._filtering = false; }), operators_1.map(function (event) { return _this.dataService.itemAt(event.indices[0]); }))
            .subscribe(function (dataItem) {
            var selectionChanged = util_1.getter(dataItem, _this.valueField) !== util_1.getter(_this.dataItem, _this.valueField);
    ...
    ComboBoxComponent.prototype.findIndexPredicate = function (text) {
        ...
        if (this.dataService.grouped) {
            return function (item) {
                var itemText = util_1.getter(item.value, _this.textField);
    ...
    ComboBoxComponent.prototype.findDataItem = function (_a) {
        ...
        var comparer = function (element) {
            ...
            return util_1.getter(dataItem, valueField) === util_1.getter(value, valueField);
        };
    ...
    ComboBoxComponent.prototype.navigate = function (index) {
        ...
        this.text = util_1.getter(this.dataService.itemAt(index), this.textField);
    ...
    ComboBoxComponent.prototype.handleBlur = function () {
        ...
        var unresolvedSelection = util_1.getter(this.dataItem, this.valueField) !== util_1.getter(this.value, this.valueField);
        var currentText = this.searchbar.value;
        var textHasChanged = currentText !== (util_1.getter(this.dataItem, this.textField) || '');
    ...
    ComboBoxComponent.prototype.useSuggestion = function () {
        ...
        var focusedItemText = util_1.getter(focusedDataItem, this.textField);
    ...
    ComboBoxComponent.prototype.subscribeTouchEvents = function () {
        ...
        this.zone.runOutsideAngular(function () {
            ...
            return _this.touchstartDisposeHandler = _this.renderer.listen(document, 'touchstart', function (e) {
                var target = e.target;
                var isInDropDown = util_1.inDropDown(_this.hostElement, target, _this.popupRef);
    ...
    ComboBoxComponent.prototype.attachSelectClickHandler = function () {
        ...
        var event = kendo_common_1.pointers ? 'pointerdown' : 'click';
