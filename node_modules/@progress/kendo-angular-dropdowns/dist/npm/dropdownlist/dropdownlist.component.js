...
var DropDownListComponent = /** @class */ (function () {
    ...
    DropDownListComponent.prototype.focusItemAt = function (index) {
        var minIndex = util_1.isPresent(this.defaultItem) ? -1 : 0;
    ...
    DropDownListComponent.prototype.subscribeEvents = function () {
        ...
        this.selectionSubscription.add(rxjs_1.merge(this.selectionService.onSelect.pipe(operators_1.filter(function (_) { return !_this.isOpen; })), this.selectionService.onChange).pipe(operators_1.map(this.itemFromEvent.bind(this)), operators_1.tap(function (_) { return _this.togglePopup(false); }))
            ...
            var shouldUseNewValue = newValue !== util_1.getter(_this.value, _this.valueField);
    ...
    DropDownListComponent.prototype.itemFromEvent = function (event) {
        ...
        var value = util_1.getter(dataItem, this.valueField);
    ...
    DropDownListComponent.prototype.componentBlur = function () {
        ...
        var valueHasChanged = selectionPresent && util_1.getter(this.value, this.valueField) !== util_1.getter(this.dataService.itemAt(this.selectionService.selected[0]), this.valueField);
        if (valueHasChanged ||
    ...
    DropDownListComponent.prototype.findDataItem = function (_a) {
        ...
        var prop = function (dataItem) { return util_1.getter(dataItem, valueField); };
        var comparer;
    ...
    DropDownListComponent.prototype.setState = function () {
        ...
        if (this.defaultItem) {
            var defaultValue = util_1.getter(this.defaultItem, valueField);
            var currentValue = util_1.getter(value, valueField);
