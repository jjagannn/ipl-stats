...
var checkboxes_settings_1 = require("../common/models/checkboxes-settings");
...
var MultiSelectComponent = /** @class */ (function () {
    ...
    MultiSelectComponent.prototype.focusItemAt = function (index) {
        ...
        if (util_1.isPresent(index) && isInRange && !this.disabledItemsService.isIndexDisabled(index)) {
    ...
    Object.defineProperty(MultiSelectComponent.prototype, "checkboxes", {
        ...
        set: function (settings) {
            this._checkboxes = checkboxes_settings_1.normalizeCheckboxesSettings(settings);
        },
        enumerable: true,
        configurable: true
    });
    ...
    Object.defineProperty(MultiSelectComponent.prototype, "activeDescendant", {
        get: function () {
            ...
            return prefix + "-" + util_1.getter(item, this.valueField);
        },
        enumerable: true,
        configurable: true
    });
    ...
    MultiSelectComponent.prototype.change = function (event) {
        ...
        if (util_1.isPresent(event.removed)) {
            ...
            var filter_1 = function (item) { return util_1.getter(item, _this.valueField) !== util_1.getter(dataItem_1, _this.valueField); };
    ...
    MultiSelectComponent.prototype.setState = function (value) {
        ...
        if (this.selectedDataItems.length < value.length) {
            this.selectedDataItems = value
                ...
                var dataItem = _this.selectedDataItems.find(function (item) { return util_1.getter(item, _this.valueField) === util_1.getter(current, _this.valueField); });
    ...
    MultiSelectComponent.prototype.subscribeTouchEvents = function () {
        ...
        this._zone.runOutsideAngular(function () {
            ...
            return _this.touchstartDisposeHandler = _this.renderer.listen(document, 'touchstart', function (e) {
                var target = e.target;
                if ((_this.isFocused || _this.isOpen) && !util_1.inDropDown(_this.hostElement, target, _this.popupRef)) {
    ...
    MultiSelectComponent.prototype.removeGroupTag = function (dataItems) {
        ...
        var dataItemValues = new Set(dataItems.map(function (item) { return util_1.getter(item, _this.valueField); }));
        this.value = this.value.filter(function (value) { return !dataItemValues.has(util_1.getter(value, _this.valueField)); });
        this.emitValueChange();
    };
    MultiSelectComponent.prototype.removeSingleTag = function (dataItem) {
        ...
        if (util_1.isNumber(index)) {
            ...
            var filter_2 = function (item) { return util_1.getter(item, _this.valueField) !== util_1.getter(dataItem, _this.valueField); };
    ...
    MultiSelectComponent.prototype.findIndex = function (text, startsFrom) {
        ...
        var index = this.dataService.findIndex(function (item) {
            if (_this.dataService.grouped) {
                itemText = util_1.getter(item.value, _this.textField);
            }
            else {
                itemText = util_1.getter(item, _this.textField);
            }
    ...
    MultiSelectComponent.prototype.resolveDataItemFromTags = function (value) {
        ...
        return tags.find(function (tag) { return util_1.getter(tag, _this.valueField) === util_1.getter(value, _this.valueField); });
    };
