...
var AutoCompleteComponent = /** @class */ (function () {
    function AutoCompleteComponent(localization, dataService, popupService, selectionService, navigationService, disabledItemsService, _zone, cdr, renderer, hostElement, touchEnabled) {
    ...
    AutoCompleteComponent.prototype.handleEnter = function (event) {
        ...
        if (focused >= 0) {
            ...
            var match = this.suggest && this.suggestedText && this.data.length &&
                util_1.getter(this.dataService.itemAt(0), this.valueField).toLowerCase() === this.searchbar.value.toLowerCase();
