 ...
 */
export declare const inDropDown: (host: ElementRef<any>, target: HTMLElement, popupRef: PopupRef) => boolean;
/**
 * @hidden
 *
 ...
 */
export declare const fetchDescendentNodes: (lookup: TreeItemLookup, filterExpression?: (lookup: TreeItem) => boolean) => TreeItemLookup[];
/**
 * @hidden
 *
