...
var MultiSelectComponent = /** @class */ (function () {
    ...
    MultiSelectComponent.prototype.removeGroupTag = function (dataItems) {
        ...
        this.value = this.value.filter(function (value) { return !dataItemValues.has(getter$1(value, _this.valueField)); });
        this.emitValueChange();
    };
...
var DropDownTreeComponent = /** @class */ (function () {
    function DropDownTreeComponent(popupService, navigationService, renderer, hostElement, _zone, cdr, localization, touchEnabled$$1) {
         ...
         */
        this.isNodeVisible = function () { return true; };
        /**
...
var MultiSelectTreeComponent = /** @class */ (function () {
    ...
    MultiSelectTreeComponent.prototype.handleKeydown = function (event) {
        var deleteTag = !this.isTreeViewActive && event.keyCode === Keys.Backspace && this.tags.length > 0;
        if (deleteTag) {
            this.handleBackspace();
            return;
        }
...
var FilterDirective = /** @class */ (function () {
    ...
    FilterDirective.prototype.ngOnChanges = function (changes) {
        if (isPresent(changes.rawSettings)) {
            this.filterSettings = this.normalizeFilterSettings(this.rawSettings);
        }
    };
    ...
    FilterDirective.prototype.normalizeFilterSettings = function (settings) {
