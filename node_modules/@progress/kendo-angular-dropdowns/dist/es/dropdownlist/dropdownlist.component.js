...
import { isPresent, guid, getter, shuffleData, sameCharsOnly, matchText, isUntouched, inDropDown } from '../common/util';
...
var DropDownListComponent = /** @class */ (function () {
    ...
    DropDownListComponent.prototype.subscribeEvents = function () {
        ...
        this.selectionSubscription.add(merge(this.selectionService.onSelect.pipe(filter(function (_) { return !_this.isOpen; })), this.selectionService.onChange).pipe(map(this.itemFromEvent.bind(this)), tap(function (_) { return _this.togglePopup(false); }))
            ...
            var shouldUseNewValue = newValue !== getter(_this.value, _this.valueField);
    ...
    DropDownListComponent.prototype.itemFromEvent = function (event) {
        ...
        var value = getter(dataItem, this.valueField);
    ...
    DropDownListComponent.prototype.componentBlur = function () {
        ...
        var valueHasChanged = selectionPresent && getter(this.value, this.valueField) !== getter(this.dataService.itemAt(this.selectionService.selected[0]), this.valueField);
        if (valueHasChanged ||
    ...
    DropDownListComponent.prototype.findDataItem = function (_a) {
        ...
        var prop = function (dataItem) { return getter(dataItem, valueField); };
        var comparer;
    ...
    DropDownListComponent.prototype.setState = function () {
        ...
        if (this.defaultItem) {
            var defaultValue = getter(this.defaultItem, valueField);
            var currentValue = getter(value, valueField);
