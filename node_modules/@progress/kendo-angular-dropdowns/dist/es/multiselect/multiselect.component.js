...
import { guid, isPresent, isArray, isObjectArray, resolveAllValues, selectedIndices, getter, isNumber, isUntouched, inDropDown } from '../common/util';
...
var MultiSelectComponent = /** @class */ (function () {
    ...
    MultiSelectComponent.prototype.change = function (event) {
        ...
        if (isPresent(event.removed)) {
            ...
            var filter_1 = function (item) { return getter(item, _this.valueField) !== getter(dataItem_1, _this.valueField); };
    ...
    MultiSelectComponent.prototype.setState = function (value) {
        ...
        if (this.selectedDataItems.length < value.length) {
            this.selectedDataItems = value
                ...
                var dataItem = _this.selectedDataItems.find(function (item) { return getter(item, _this.valueField) === getter(current, _this.valueField); });
    ...
    MultiSelectComponent.prototype.removeGroupTag = function (dataItems) {
        ...
        var dataItemValues = new Set(dataItems.map(function (item) { return getter(item, _this.valueField); }));
        this.value = this.value.filter(function (value) { return !dataItemValues.has(getter(value, _this.valueField)); });
        this.emitValueChange();
    };
    ...
    MultiSelectComponent.prototype.findIndex = function (text, startsFrom) {
        ...
        var index = this.dataService.findIndex(function (item) {
            if (_this.dataService.grouped) {
                itemText = getter(item.value, _this.textField);
            }
            else {
                itemText = getter(item, _this.textField);
            }
    ...
    MultiSelectComponent.prototype.resolveDataItemFromTags = function (value) {
        ...
        return tags.find(function (tag) { return getter(tag, _this.valueField) === getter(value, _this.valueField); });
    };
